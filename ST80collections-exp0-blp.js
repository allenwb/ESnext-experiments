...
The code uses the following proposed ES.next extension:
   ...
   *  Object.extend() function -- extends the 1st arg object with properties from 2nd arg
       (for these examples, we also assume that it magicly goes super rebinding when transferring
        methods fron the 2nd arg to the 1st. There may be issues with this)
...
const className = Object.extend(Object.extend(superClass <| function(/*constructor parameters * /) {
  //constructor body 
...
export const Collection = Object.extend(Object.extend(AbstractClass <| function(n) {
	}.prototype, {
	  //adding protocol
...
export const Set = Object.extend(Object.extend(Collection <| function(initialSize=2) {
...
export const Bag = Object.extend(Object.extend(Collection <| function() {
	   Object.extend(this, {
...
export const Dictionary = Object.extend(Object.extend(Set <| function(...args) {
...
export const  SequenceableCollection = Object.extend(Object.extend(Collection <| function(){
	  super.constructor();
	}.prototype, {
	  //accessing protocol
    ...
    const BasicStorageCollection = Object.extend(Object.extend(SequenceableCollection <| function(elements) {
      super.constructor();
	  Object.extend(this, {
	...
	*/
export const ArrayedCollection = Object.extend(Object.extend(SequenceableCollection <| function(elements=0) {
...
export const SmalltalkArray = Object.extend(Object.extend(ArrayedCollection <| function(elements=0) {
	  super.constructor(elements);
	}.prototype, {
	  //converting protocol
	  asArray() {return this}
...
export const Interval = Object.extend(Object.extend(SequenceableCollection <| function() {
	  super.constructor();
	}.prototype, {
	  //accessing protocol
	  get size() {
...
export const  OrderedCollection = Object.extend(Object.extend(BasicStorageCollection <| function(space=10) {
