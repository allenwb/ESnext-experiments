...
**** this version is just like exp1 except that it uses the word beget in place of <| 
...
The code uses the following proposed ES.next extension:
   ...
   *  the beget operator -- defines the [[Prototype]] of a literal
...
For these examples beget used with a function expression sets the [[Prototype]] of the object created
...
const className = superClass beget function(/*constructor parameters * /) {
  //constructor body 
...
module SmalltalkCollections {	
	...
	const AbstractClass = Function.prototype beget {
	  ...
	  name: "AbstractClass",
	  prototype: Object.prototype beget{
...
export const Collection = AbstractClass beget function(n) {
	}.prototype.{
	  //adding protocol
...
export const Set = Collection beget function(initialSize=2) {
...
export const Bag = Collection beget function() {
	   this.{
...
export const Dictionary = Set beget function(...args) {
...
export const  SequenceableCollection = Collection beget function(){
	  super.constructor();
	}.prototype.{
	  //accessing protocol
    ...
    const BasicStorageCollection = SequenceableCollection beget function(elements) {
      super.constructor();
	  this.{
	...
	*/
export const ArrayedCollection = SequenceableCollection beget function(elements=0) {
...
export const SmalltalkArray = ArrayedCollection beget function(elements=0) {
	  super.constructor(elements);
	}.prototype.{
	  //converting protocol
	  asArray() {return this}
...
export const Interval = SequenceableCollection beget function() {
	  super.constructor();
	}.prototype.{
	  //accessing protocol
	  get size() {
...
export const  OrderedCollection = BasicStorageCollection beget function(space=10) {
