...
***** This Version is just like exp1-nocomma except that features that are not currently 
***** supported by Narcissus are commented out. 
...
//module SmalltalkCollections {	
 ...
 const Collection = AbstractClass <| function(n) {
	}.prototype.{
	  //adding protocol
 ...
 const Set = Collection <| function(initialSize/*=2*/) {
 ...
 const Dictionary = Set <| function(/*...*/args) {
 ...
 const  SequenceableCollection = Collection <| function(){
	  super.constructor();
	}.prototype.{
	  //accessing protocol
 ...
 const SmalltalkArray = ArrayedCollection <| function(elements/*=0*/) {
	  super.constructor(elements);
	}.prototype.{
	  //converting protocol
	  asArray() {return this}
 ...
 const Interval = SequenceableCollection <| function() {
	  super.constructor();
	}.prototype.{
	  //accessing protocol
	  get size() {
