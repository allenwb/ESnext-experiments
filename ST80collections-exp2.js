...
***** This Version uses obj.={ } instead of obj.{ } as the object extensions syntax

This code has not been tested.  It undoubtably has bugs and have may syntax errors.
...
export const Collection = AbstractClass <| function(n) {
	  ...
	  //removing protocol
	  removeIfAbsent(anObj,errHandler) {self.subclassResponsibility},
	  remove(anObj) {
		const self=this;
