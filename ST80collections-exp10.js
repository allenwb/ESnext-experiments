...
module SmalltalkCollections {	
  ...
  //class properties
  Object.defineMethod(AbstractClass,"subclassResponsibility", function () {
     throw new Error(this.className+" did not implemented an abstract method")
   });
  Object.defineMethod(AbstractClass,"shouldNotImplement", function() {
     throw new Error(this.className+" should not implemented by "+this.name)
  });
  Object.className = "AbstractClass"
  ...
  */
  ...
  export class Set extends Collection {
    constructor(initialSize=2) {   
	   this.@setContents = new Array(initialSize);
	   this.@setTally = 0;
	};
    //accessing protocol
  ...
  */
  ...
  export class Bag extends Collection {
    constructor() {
	   this.@bagContent = new Dictionary();
	}
    //accessing protocol
    at(index) {return this.errorNotKeyed()}
    atPut(index, anObject) {return this.errorNotKeyed()}
  ...
  //class properties
  SequenceableCollection.className = "SequenceableCollection";
  ...
  class BasicStorageCollection extends SequenceableCollection {
    constructor(elements) {
      super();
	  this.@storage: new Array(elements+1);
	}
  ...
  //class properties
  BasicStorageCollection.className = "BasicStorageCollection";
  ...
  //class properties
  Object.defineMethod(ArrayedCollection, "newWithAll", function(size,value) {
     return (new this(size)).atAllPut(value);
  });
  Object.defineMethod(ArrayedCollection, "with", function(...args) {
	  const newCollection = new this(args.length);
	  let i = 1;
  ...
  //class properties
  ArrayedCollection.className = "ArrayedCollection";
  ...
  //class properties
  SmalltalkArray.className = "(Smalltalk)Array";
  ...
  //class properties
  Object.defineMethod(Interval,"fromTo", function(startInteger,stopInteger) {
     return this.fromToBy(startInteger,stopInteger,1);
  });
  Object.defineMethod(Interval,"fromToBy" function(startInteger,stopInteger,stepInteger) {
	let newObj = new this;
	newObj.@start: Math.round(startInteger);
	newObj.@stop:  Math.round(stopInteger);
	newObj.@step:  Math.round(stepInteger);
    return newObj;
  });
  ...
  export class OrderedCollection extends BasicStorageCollection {
    constructor(space=10) {
      ...
      this.@firstIndex = firstIndx;
      this.@lastIndex = Math.max(firstIndx-1,0);
    }
    //accessing protocol
  ...
  //class properties
  Object.defineMethod(OrderedCollection,"newFrom", function(aCollection) {
      const newCollection = new this(aCollection.size);
      newCollection.addAdd(aCollection);
      return newCollection;
  });
  OrderedCollection.className = "OrderedCollection";
